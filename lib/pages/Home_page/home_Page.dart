...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _initializeApp() async {
    ...
    if (user != null) {
      if (!mounted) return;
      try {
        // Get address from coordinates (for pincode)
        ...
        late final StreamSubscription<AddressState> streamSubscription;

        final addressBloc = context.read<AddressBloc>();

        // Setup the listener
        streamSubscription = addressBloc.stream.listen((state) {
        ...
        // Trigger warehouse check with dynamic location
        ...
        addressBloc.add(GetWarehousedetailsEvent(
          ...
          locationmode.Location(lat: 00.00, lang: 00.00), // Default location
        ));
        GoRouter.of(context).go('/home');
      }
    } else {
        ...
        return Container(
          decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                1.0
                  ...
                  colors: [
                parseColor(uiData["template1"]["appbarcolor"]),
                parseColor(uiData["template1"]["appbarcolor"]),
          ...
          child: Scaffold(
              ...
              body: InkWell(
                ...
                // FFfecc6c
                child: SafeArea(
                  child: BlocBuilder<HomeUiBloc, HomeUiState>(
